...
function Team() {
    ...
    return  <section className="h-fit px-2 mt-16 sm:px-10 flex items-center justify-center flex-col gap-16">
        ...
        <div className="xl:w-1/3 w-full flex justify-center">
            {<Card img = "noura.jpg" name="Eng.Nowraa Hamdy" role = "Teaching assistant" linkedIn = "" facebook = "" cardWidth = "full" transition="zoom-in-up"/>}
        </div>
        ...
        <div className="w-full flex flex-col xl:flex-row gap-7 xl:gap-10 items-center justify-center">
            {<Card img = "omar.png" name="Omar Fathy" role = "Flutter" linkedIn = "https://www.linkedin.com/in/omar-fathy-3ab882253/" facebook = "https://www.facebook.com/profile.php?id=100071711035941" cardWidth = "[30%]" transition="zoom-out-right"/>}
