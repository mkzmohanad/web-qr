...
function About() {
    ...
    return <div className="h-full px-2 sm:p-10 flex xl:flex-row gap-16 justify-between flex-wrap mt-96 md:m-32 lg:mt-10" >
        ...
        <div className="bg-aboutColor w-full xl:w-[46%] sm:h-[400px] p-5 rounded-xl text-white" data-aos="fade-right">
        ...
        <div className="bg-aboutColor w-full xl:w-[46%] sm:h-[400px] p-5 rounded-xl text-white" data-aos="fade-left">
